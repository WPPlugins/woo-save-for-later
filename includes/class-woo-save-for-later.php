...
class Woo_Save_For_Later {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_add_plugin_user_wsfl', $plugin_admin, 'wp_add_plugin_userfn_wsflfree' );
		$this->loader->add_action( 'wp_ajax_add_nopriv_plugin_user_wsfl', $plugin_admin, 'wp_add_plugin_userfn_wsflfree' );
