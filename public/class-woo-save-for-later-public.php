...
class Woo_Save_For_Later_Public {
	...
	public function wsfl_assign_view_template( $template ) {
		...
		$this->templates = array(
		'wsfl-page-template.php' => __( 'Default - Save For Later', WSFL_PLUGIN_SLUG ),
		);
	...
	public function wsfl_add_link_in_cart_list( $product_name, $cart_item, $cart_item_key) {
		...
		if ( !( defined( 'DOING_AJAX' ) && DOING_AJAX ) ) {
			...
			$href = '<div class="wsfl_button"><a href="javascript:void(0);" rel="" class="set_wsfl_save_for_later" title="' . $text_link . '" data-product-id="' . $product_id . '">' . $text_link . '</a></div>';
