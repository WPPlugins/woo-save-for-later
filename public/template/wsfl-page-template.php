...
if( in_array( 'woocommerce/woocommerce.php',apply_filters('active_plugins',get_option('active_plugins')))  ) { 
	...
	if( !empty( $getWSFLCookie ) && $getWSFLCookie !='' ) { ?>
			  ...
			  <?php
			  	...
			  	foreach ( $getWSFLCookie as $key=>$value ) {
					...
					<?php } ?>
						...
						<td><img src="<?php echo $getProductImage[0]; ?>" width="50px" height="50px" alt="<?php echo $productArr->post_title;?>"></td>
						<td><a target="_blank" href="<?php echo get_the_permalink($key);?>"><?php echo $productArr->post_title;?></a></td>
						<td><?php echo $value; ?></td>
						<td><?php echo $PriceHtml; ?></td>
						<td>
							<a href="javascript:void(0);" class="wsfl_add_product_to_cart" id="<?php echo $key;?>"><img src="<?php echo WSFL_PLUGIN_PATH.'/images/wsfl_add_to_cart.png';?>" alt="Add to cart"></a>
							<a href="javascript:void(0);" class="remove_product_to_wsfl" id="<?php echo $key;?>"><img src="<?php echo WSFL_PLUGIN_PATH.'/images/wsfl_trash.png';?>" alt="Remove"></a>
						</td>
					</tr>
	...
	<?php } else { echo "<h3>No Product set in save for later.!!!</h3>"; }
