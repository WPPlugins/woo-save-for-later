...
<div id="main-tab">
    <div class="wrapper">
        <div class="tab-dot">
            <div class="wcpfc-main-table res-cl key-featured">
                <h2>Free vs Pro </h2>
                <table class="table-outer premium-free-table" align="center">
                    ...
                    <tr class="dark">
                        ...
                        <td><img src="<?php echo WSFL_PLUGIN_URL . 'admin/images/check-mark.png'; ?>"></td>
                        <td><img src="<?php echo WSFL_PLUGIN_URL . 'admin/images/check-mark.png'; ?>"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo WSFL_PLUGIN_URL . 'admin/images/trash.png'; ?>"></td>
                        <td><img src="<?php echo WSFL_PLUGIN_URL . 'admin/images/check-mark.png'; ?>"></td>
                    </tr>
                    ...
                    <tr class="pad radius-s">
                        <td class="pad"></td>
                        <td></td>
                        <td class="green red"><a href="https://store.multidots.com/woocommerce-save-for-later-cart-enhancement/" target="_blank">UPGRADE TO <br> PREMIUM VERSION </a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
